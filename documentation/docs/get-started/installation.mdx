...
First you need to enter your project name

<AppNameInputBox />

<appName type={"uppercase"} />
<br />
<appName type={"lowercase"} />
...
MyApp is the name of your project, you can change it to whatever you want
